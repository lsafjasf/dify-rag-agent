...
BUILTIN_DATASET: List[EvalSample] = [
    ...
    EvalSample(
        ...
        relevant_sources=["chatflow.mdx", "chat.mdx"],
        category="Chatflow",
    ),
    EvalSample(
    ...
    EvalSample(
        ...
        relevant_sources=["chatflow.mdx", "human-input-flow.mdx"],
        category="Chatflow",
    ),
    ...
    EvalSample(
        ...
        relevant_sources=["knowledge.mdx"],
        category="知识库",
    ),
    EvalSample(
    ...
    EvalSample(
        ...
        relevant_sources=["chat.mdx", "knowledge.mdx"],
        category="WebApp",
    ),
    EvalSample(
    ...
    EvalSample(
        ...
        relevant_sources=["chat.mdx", "chatflow.mdx"],
        category="对话管理",
    ),
]
